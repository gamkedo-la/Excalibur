function drawScore() {
	...
	if (twoPlayerMode && !orchestratorMode) {
		...
		colorText("Shots Fired: " + shotsFired, canvas.width - 10, 150, "white", "20px Arial", "right");
		colorText("Number Of Hits: " + shotsHit, canvas.width - 10, 170, "white", "20px Arial", "right");
		colorText("Ships Hit: " + shotsHitShips, canvas.width - 10, 190, "white", "20px Arial", "right");
		colorText("Aliens Hit: " + shotsHitAliens, canvas.width - 10, 210, "white", "20px Arial", "right");
		colorText("Parachutes Hit: " + shotsHitParachutes, canvas.width - 10, 230, "white", "20px Arial", "right");

		colorText("Time Elapsed: " + timeElapsedInSeconds.toFixed(1), canvas.width - 10, 270, "white", "20px Arial", "right");
		colorText("Frame Rate: " + (frameCount / timeElapsedInSeconds).toFixed(1), canvas.width - 10, 290, "white", "20px Arial", "right");
